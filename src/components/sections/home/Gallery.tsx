...
export default function Gallery() {
  ...
  sizes="(max-width: 768px) 50vw, 25vw"/>   <span className="text-white text-xs tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300">JONATHAN <span className="font-normal">ROUMIE</span></span>
            </div>
          </motion.div>
        ))}
      </div>
