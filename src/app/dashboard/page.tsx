...
import { LogOut, Clock, CheckCircle, AlertCircle, Download, QrCode, User, DollarSign } from 'lucide-react'
          ...
          {!whitelisted ? (
            ...
            <>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white/3 border border-white/5 rounded-2xl p-8 mb-8">
                <h2 className="text-white text-lg font-black tracking-widest mb-4">YOUR FAN CARD</h2>
